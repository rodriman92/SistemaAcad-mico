...
var guardarInstructor = () => {
    ...
    var action = 'Instructors/guardarInstructor';
    ...
    var direccion = document.getElementById("Direccion").value;
    var estado = document.getElementById("Estado").checked;
    instructores.guardarInstructor(idInstructor, funcion, action, especialidad, nombre, apellido, fecha, documento, email, telefono, direccion, estado);
    idInstructor = 0;
}
var filtrarInstructores = (numPagina, order) => {
    var valor = document.getElementById("filtrar").value;
    var action = 'Instructors/filtrarInstructores';
...
var editarInstructor = (id, fun) => {
    idInstructor = id;
    funcion = fun;
    var action = 'Instructors/getInstructor';
...
var deleteInstructores = () => {
    var action = 'Instructors/deleteInstructor';
    instructores.deleteInstructor(idInstructor, action);
    idInstructor = 0;
}


var restablecerInstructores = () => {
    instructores.restablecer();
}
